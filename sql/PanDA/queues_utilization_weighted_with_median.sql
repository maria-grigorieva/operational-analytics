...
SELECT tstart,
       ...
       round(n_finished/nullif(n_running+n_holding+n_transferring+n_merging,0),2) as performance,
       avg_waiting_time,
       avg_running_time,
       avg_merging_time,
       ...
       round(running_finished/nullif((running_completed),0),2) as efficiency_weighted
FROM r1