from queues_metrics import jobs_statuslog_extended, jobs_statuslog_nucleus
...
def retrospective_collector(frequency='1h'):
    ...
    end_date = datetime(2026, 7, 12, 12, 0, 0) # next --> 2022-12-21 09:00:00
    ...
    for i in list_of_dates[::-1]:
        print(i)
        jobs_statuslog_nucleus(predefined_date=i)
        jobs_statuslog_extended(predefined_date=i)
        # queues_hourly_to_db(metric='queues_hourly', predefined_date = i)
        # queues_workload_weighted_detailed(predefined_date = i)

#jobs_statuslog_extended(predefined_date='2026-07-12 11:00:00', queues='actual')
jobs_statuslog_nucleus(predefined_date='2026-07-12 11:00:00')
